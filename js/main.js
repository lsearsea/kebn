var vm = new Vue({
    ...
    data:{
        ...
        Junior:'<li><span class="a" id="a2">初中课本</span><ul class="b" id="b2"><li>语文</li><li>数学</li><li>英语</li><li>物理</li><li>化学</li><li>道德与法治</li><li>历史</li><li>地理</li><li>生物</li><li>体育</li><li>音乐</li><li>美术</li><li>信息技术</li></ul>',
...
(function() {
  ...
  hm.src = "https://stats.holzora.com/kebn/cn/stats.php";
